...
df = pd.DataFrame({'Time': TIME, 'Precipitation': prectot,'pressure': press_data,'humidex': humidex_data, 'Rosee': td_data,'Temperature': temp_data,'Humidite': humi_data,'Dir_wind':  mean_dir,'Mod_wind':   mean_mod}, columns = ['Time','Precipitation', 'pressure', 'humidex', 'Rosee','Temperature','Humidite','Dir_wind','Mod_wind']) 
df = df.set_index('Time')   
df.to_csv('/NFS2_RESCUE2/stationuqam/programmes/preparation_donnees/data/UQAM_DATA_STATION.csv')
