...
query = ("select * from gault_fluxdata ORDER BY DATE DESC LIMIT 1;")

df = pd.read_sql_query(query, con=cnx)
df = df.set_index('DATE')
df = df.round(3)
df.to_csv('/aos/home/gdueymes/tmp/prepare_data_website/Sentinel_1/data/station_last_flux_data.csv')
